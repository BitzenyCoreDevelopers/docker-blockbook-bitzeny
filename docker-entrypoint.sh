...
RPC_PORT="${RPC_PORT:-9252}"
MQ_PORT="${MQ_URL:-38395}"
...
exec ./blockbook -blockchaincfg=/blockbook/config/blockchaincfg.json -datadir=/blockbook/db -workers=${WORKERS:-1} -public=:${BLOCKBOOK_PORT:-9195} -logtostderr "$@"
